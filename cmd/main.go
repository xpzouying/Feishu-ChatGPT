...
import (
	...
	"github.com/xpzouying/Feishu-ChatGPT/internal/repo/feishu"
	"github.com/xpzouying/Feishu-ChatGPT/internal/server"
	"github.com/xpzouying/Feishu-ChatGPT/internal/service"
...
func main() {
	...
	service := service.NewFeishuService(feishuEx)
